# ── win32/SetupQt.cmake ───────────────────────────────────────────────────────
# Windows Qt setup – unchanged from original SetupQt.cmake.
# Called via win32/win32.cmake → check_os.cmake → CMakeLists.txt
# ─────────────────────────────────────────────────────────────────────────────

set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_DEBUG
        ${CMAKE_SOURCE_DIR}/build/debug_app)
set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_RELEASE
        ${CMAKE_SOURCE_DIR}/build/${PROJECT_NAME}_${APPVERSION}_win)
...
function(setup_qt_target target_name)
    ...
    if(WIN32)
        find_program(WINDEPLOYQT_EXECUTABLE windeployqt6
                     HINTS "${QT_DIR}/bin" "C:/Qt/6.11.0/mingw_64/bin")
